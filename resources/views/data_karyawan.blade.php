...
<section class="py-1 bg-blueGray-50">
    <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
            <div class="rounded-t px-4 py-3 border-0 mb-8">
                <div class="flex flex-wrap items-center">
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                        <h3 class="font-semibold text-base text-blueGray-700 mb-8">Data Karyawan</h3>
                        <a href="/"
                    ...
                    <tbody>
                        @forelse ($karyawan as $item)
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <a href="{{ url('karyawan/detail/' . $item->kode_karyawan) }}"
                                        class="bg-blue-500 font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-blue-600 mr-6">
                                        Detail
                                    </a>
                                    <a style="background-color: red;"
                                        href="{{ url('karyawan/delete/' . $item->kode_karyawan) }}"
                                        class=" font-bold text-white px-4 py-3 transition duration-300 ease-in-out hover:bg-blue-600 mr-6">
                                        Delete
                                    </a>
                                </td>
                            </tr>
