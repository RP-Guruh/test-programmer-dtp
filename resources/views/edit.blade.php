            ...
            <div class="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-indigo-400 rounded-t">
                <div class="max-w-sm mx-auto md:w-full md:mx-0">
                    <div class="inline-flex items-center space-x-4">
                        ...
                        <h1 class="text-black-600 font-bold">Edit Data Karyawan</h1>
            ...
            <div class="bg-white space-y-6">
                ...
                <div class="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                    ...
                    <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                        ...
                        <input value="{{ $karyawan->kode_karyawan }}" hidden name="kode_karyawan" type="text"
                ...
                <div class=" border-b border-gray-200 pb-4 mb-4">
                    <div class="w-64 font-bold h-6 mx-2 mt-3 text-red-800 mb-8">Pendidikan
                        <button type="button" name="add" id="add" class="text-blue-500">Tambah Field</button>
                    </div>
                ...
                <div class=" border-b border-gray-200 pb-4 mb-4">
                    <div class="w-64 font-bold h-6 mx-2 mt-3 text-red-800 mb-8">Pekerjaan
                        <button type="button" name="add" id="addPekerjaan" class="text-blue-500">Tambah Field</button>
                    </div>
